...
int main(int, char*[])
{
  ...
  vtkNew<vtkProperty> coneProperty2;
  coneProperty->SetDiffuseColor(colors->GetColor3d("bisque").GetData());
  coneProperty2->SetDiffuseColor(colors->GetColor3d("bisque").GetData());
  ...
  actor2->SetProperty(coneProperty2);
  actor2->SetPosition(0, 1, 0);
  coneProperty2->SetColor(colors->GetColor3d("LightSeaGreen").GetData());
